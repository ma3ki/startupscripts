...
cp -p /usr/share/nginx/html/50x.html ${HTTP_DOCROOT}
cp -p /usr/share/nginx/html/50x.html ${HTTPS_DOCROOT}
cp -p /usr/share/nginx/html/404.html ${HTTP_DOCROOT}
cp -p /usr/share/nginx/html/404.html ${HTTPS_DOCROOT}
